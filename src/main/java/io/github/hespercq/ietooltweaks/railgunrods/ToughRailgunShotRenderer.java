...
public class ToughRailgunShotRenderer extends EntityRenderer<ToughRailgunShotEntity> {
	...
	public static void renderRailgunProjectile(double yaw, double pitch, RailgunRenderColors colors, PoseStack matrixStackIn, MultiBufferSource bufferIn, int light) {
		...
		TransformingVertexBuilder builder = new TransformingVertexBuilder(bufferIn.getBuffer(IERenderTypes.POSITION_COLOR_LIGHTMAP), matrixStackIn, IERenderTypes.POSITION_COLOR_LIGHTMAP.format());
