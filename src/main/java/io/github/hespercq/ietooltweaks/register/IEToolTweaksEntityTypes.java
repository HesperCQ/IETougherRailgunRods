...
public class IEToolTweaksEntityTypes {
	...
	// Tough Railgun Shot
	public static final RegistryObject<EntityType<ToughRailgunShotEntity>> TOUGH_RAILGUN_SHOT = REGISTER.register("tough_railgun_shot",
			() -> EntityType.Builder.<ToughRailgunShotEntity>of(ToughRailgunShotEntity::new, MobCategory.MISC).sized(.5F, .5F).build(IEToolTweaks.MODID + ":" + "tough_railgun_shot"));
}
